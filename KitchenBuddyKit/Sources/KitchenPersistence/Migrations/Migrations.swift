...
enum Migrations {
    ...
    static let identifiers: [String] = ["v1-initial", "v2-rating-clears", "v3-health", "v4-food-mappings"]
    ...
    static func registerAll(in migrator: inout DatabaseMigrator) {
        ...
        migrator.registerMigration("v4-food-mappings") { db in
            try db.execute(sql: SchemaV4.sql)
        }
    }
}
