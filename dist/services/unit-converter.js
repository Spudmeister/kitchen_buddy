...
const VOLUME_THRESHOLDS_METRIC = [
    { max: 1000, unit: 'ml' },
    { max: Infinity, unit: 'l' },
];
const WEIGHT_THRESHOLDS_US = [
    { max: 453.592, unit: 'oz' }, // < 1 lb
    { max: Infinity, unit: 'lb' },
];
const WEIGHT_THRESHOLDS_METRIC = [
    { max: 1000, unit: 'g' },
...
export class UnitConverter {
     ...
     */
    convertToSystem(ingredient, targetSystem) {
        ...
        const targetUnit = this.getBestUnitForSystem(ingredient.quantity, ingredient.unit, targetSystem);
        if (targetUnit === null) {
            return { ...ingredient };
        }
     ...
     */
    scaleIngredientInput(ingredient, factor) {
        return {
            ...ingredient,
            quantity: ingredient.quantity * factor,
        };
     ...
     */
    roundToPractical(quantity, unit) {
     ...
     */
    getBestUnitForSystem(quantity, fromUnit, targetSystem) {
