 ...
 */
export type VisualParserImageFormat = 'image/jpeg' | 'image/png' | 'image/heic' | 'image/heif' | 'image/tiff';
/**
 * All supported visual parser image formats
 */
export declare const VISUAL_PARSER_SUPPORTED_FORMATS: VisualParserImageFormat[];
/**
